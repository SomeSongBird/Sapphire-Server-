...
public class Routing implements IRouting{
    ...
    public void startRouting(){
        ...
        post("/update_directory/request", (req,res)-> taskManager.startNewTask(TaskType.directory, new StructuredRequest(req,"POST")));
        ...
        post("/remote_start/request", (req,res)-> taskManager.startNewTask(TaskType.remoteStart, new StructuredRequest(req,"POST")));
        ...
        post("/file_transfer/request",(req,res)-> taskManager.startNewTask(TaskType.fileTransfer, new StructuredRequest(req,"POST")));  
