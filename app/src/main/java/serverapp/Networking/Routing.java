...
public class Routing implements IRouting{
    ...
    public void startRouting(){
        ...
        //post("/file_lookup/request", (req,res)-> taskManager.startNewTask(TaskType.directory, new Request(req.body())));
        ...
        post("/file_transfer/request",(req,res)-> taskManager.startNewTask(TaskType.fileTransfer, new StructuredRequest(req)));  
        post("/file_transfer/compliance",(req,res)-> taskManager.updateTasks(new StructuredRequest(req)));
    }
